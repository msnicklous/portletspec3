...
(function () {
   ...
   /**
    * Sets up the portlet hub implemetation for use. 
    * @private
    */
   function initialize () {
      if (isInitialized) {
   ...
   portlet.test = {
         ...
         getInitData : portlet.impl.getInitData,
         getIds : portlet.impl.getIds,
         decodeUpdateString : portlet.impl.decodeUpdateString,

   };
   
   /**
    * For each portlet, ere is an update string that         
